...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        handleMultiMessage: function (msgIdx, args) {
            if (msgIdx === Enums.eMessage.NPCHitUser) { // TODO hacer case // target es el lugar donde le pego, pierna brazo, etc
                this.game.realizarDanio(this.game.player.id, args[1]);
                //self.infoManager.addDamageInfo(-danio, this.game.player.x + this.renderer.INTERFAZ_OFFSET_X, this.characters[CharIndex].y - 15 + +this.renderer.INTERFAZ_OFFSET_Y, "received");
            }
            console.log("TODO: handleMultiMessage ");
        },
