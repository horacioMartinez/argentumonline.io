...
define(['lib/howler', 'lib/pixi'],
    function (__howler__, PIXI) {
        ...
        var Preloader = Class.extend({
            ...
            _agregarPreloadMapas: function (loader) { // TODO (IMPORTANTE): comprimir los mapas con http://pieroxy.net/blog/pages/lz-string/index.html y guardarlos en el local storage !!
