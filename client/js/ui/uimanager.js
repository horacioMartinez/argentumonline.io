...
define(['dominputhandler','ui/comerciar', 'ui/interfaz', 'ui/tirar', 'ui/boveda', 'ui/mensaje'], function (DomInputHandler, Comerciar, Interfaz,Tirar, Boveda, Mensaje) {
    ...
    var UIManager = Class.extend({
        init: function (game) {
            ...
            this.mensaje = new Mensaje(this.inputHandler);
        ...
        hayPopUpActivo: function(){
            return (this.comerciar.visible || this.tirar.visible || this.boveda.visible || this.mensaje.visible);
        },
